...
<head>
  ...
  <style>
    ...
    .logo-text {
      font-weight: 700;
      font-size: 22px;
      color: #f04e23; /* eventbrite orange */
      user-select: text;
    }
    .logo-text span {
      color: black;
    ...
    /* Highlight backgrounds for partial text */
    .highlight-orange {
      background: #f04e23;
      color: white;
      padding: 0 7px 2px;
    ...
    .hero-btn:hover {
      background-color: #f04e23;
      color: white;
      box-shadow: 0 4px 20px rgb(240 78 35 / 0.6);
    }
    ...
    .category-item:hover .circle-icon {
      border-color: #f04e23;
      color: #f04e23;
      cursor: pointer;
    }

    /* Longer text adjustments */
    .category-item.long-text {
      max-width: 130px;
      font-size: 11px;
      font-weight: 400;
      line-height: 1.3;
...
<header>
  <div class="logo-text">event<span>brite</span></div>
